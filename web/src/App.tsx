...
import { loadExpenses, updateTypes, loadImportedFile } from './operations'
...
class App extends Component {
  ...
  componentDidMount = async () => {
    const fileName = await loadImportedFile();
    ...
    return (
      <BrowserRouter forceRefresh>
        <div className="container app">
          ...
          <Switch>
            <Route path="/" exact render={() => <Home importedFileName={this.state.importedFileName} />} />
